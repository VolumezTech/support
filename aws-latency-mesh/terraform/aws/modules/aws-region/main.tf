...
# Create key pair in this region using the generated public key
...
# Security group allowing SSH, ICMP, and measurement tools
...
resource "aws_instance" "latency_node" {
  ...
  key_name               = aws_key_pair.latency_test.key_name
